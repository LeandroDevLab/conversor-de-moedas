...
<table>
      <tr>
        <th>
          <img
            src="./assets/img/PrtSc-desktop-conversor-de-moedas.png"
            alt="Print Screen da página desktop do projeto conversor de moedas"
          />
        </th>
        <th>
          <img
            src="./assets/img/PrtSc-mobile-conversor-de-moedas.png"
            alt="Print Screen da página mobile do projeto conversor de moedas"
          />
        </th>
      </tr>
    </table>
